...
public class ChronoCareApplication {
    ...
    @Bean
    public CommandLineRunner dataLoader(PatientRepository patientRepo, DoctorRepository doctorRepo) {
        return args -> {
            // Mivel fájlba mentünk, csak akkor hozzunk létre adatokat, ha az adatbázis még üres!
            if (doctorRepo.count() == 0) {
                ...
                d2.setPassword("admin");
                doctorRepo.save(d2);

                //Betegek létrehozása és hozzárendelése
                ...
                System.out.println("--- ADATBÁZIS INICIALIZÁLVA (2 orvos, 2 beteg összekötve) ---");
            } else {
                System.out.println("--- Az adatbázis már tartalmaz adatokat, nem hozunk létre újakat. ---");
            }
        };
    }
}